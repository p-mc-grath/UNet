...
# PEP420 compliant implicit namespace packages
from setuptools import find_namespace_packages, setup

# Source: https://github.com/open-mmlab/mmdetection/blob/master/setup.py
...
setup(
        name='UNet',
        version=1.0,
        description='Map Prediction',
        author='Paul Mc Grath',
        author_email='pmcgrath249@gmail.com',
        packages=find_namespace_packages(exclude=['UNet.data']),
